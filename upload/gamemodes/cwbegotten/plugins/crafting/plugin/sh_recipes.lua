...
function cwRecipes:ClockworkInitialized()
	...
	RECIPE = cwRecipes.recipes:New("wrought_iron_ingot");
		...
		RECIPE.requiredBeliefsNiceNames = {"Smith"};
		RECIPE.requirements = {
			["iron_ore"] = {amount = 1},
			["charcoal"] = {amount = 1},
		};
	...
	RECIPE = cwRecipes.recipes:New("steel_ingot");
		...
		RECIPE.requiredBeliefsNiceNames = {"Blacksmith"};
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 2},
			["charcoal"] = {amount = 1},
		};
	...
	RECIPE = cwRecipes.recipes:New("fine_steel_ingot");
		...
		RECIPE.requiredBeliefsNiceNames = {"Master Blacksmith"};
		RECIPE.requirements = {
	...
	RECIPE = cwRecipes.recipes:New("hellforged_steel_ingot");
		...
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"sorcerer"};
		RECIPE.requiredBeliefsNiceNames = {"Sorcerer"};
	...
	RECIPE = cwRecipes.recipes:New("familial_hellforged_steel_ingot");
		...
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"deceitful_snake"};
		RECIPE.requiredBeliefsNiceNames = {"Deceitful is the Snake"};
	...
	RECIPE = cwRecipes.recipes:New("maximilian_steel_ingot");
		...
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"emissary"};
		RECIPE.requiredBeliefsNiceNames = {"Emissary"};
		RECIPE.requiredFaiths = {"Faith of the Light"};
		RECIPE.requirements = {
	...
	RECIPE = cwRecipes.recipes:New("shagalaxian_steel_ingot");
		...
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"enduring_bear"};
		RECIPE.requiredBeliefsNiceNames = {"Enduring is the Bear"};
		RECIPE.requiredFaiths = {"Faith of the Family"};
		RECIPE.requirements = {
			["fine_steel_ingot"] = {amount = 2},
			["steel_ingot"] = {amount = 1},
	...
	RECIPE = cwRecipes.recipes:New("black_remedy");
		...
		RECIPE.requiredBeliefs = {"plague_doctor"};
		RECIPE.requiredBeliefsNiceNames = {"Plague Doctor"};
		RECIPE.requirements = {
	...
	RECIPE = cwRecipes.recipes:New("survivalpack");
		...
		RECIPE.requiredBeliefsNiceNames = {"Doctor"};
		RECIPE.requirements = {
	...
	RECIPE = cwRecipes.recipes:New("axe_falchion");
		RECIPE.name = "Axe & Falchion";
		RECIPE.requiredBeliefs = {"ingenious"};
		RECIPE.requiredBeliefsNiceNames = {"Ingenious"};
		RECIPE.requirements = {
			["begotten_1h_reaverbattleaxe"] = {amount = 1},
		...
		RECIPE.result = {
			["begotten_dual_goreaxe_gorefalchion"] = {amount = 1},
		};
		RECIPE.category = "Weapons"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
		RECIPE.craftTime = 8
		RECIPE.craftVerb = "combining"
		RECIPE.experience = 0;
	...
	RECIPE = cwRecipes.recipes:New("dual_axes");
		RECIPE.name = "Dual Axes";
		RECIPE.requiredBeliefs = {"ingenious"};
		RECIPE.requiredBeliefsNiceNames = {"Ingenious"};
		RECIPE.requirements = {
			["begotten_1h_gorebattleaxe"] = {amount = 2},
		};
		RECIPE.result = {
			["begotten_dual_axes"] = {amount = 1},
		};
		RECIPE.category = "Weapons"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("dual_scimitars");
		RECIPE.name = "Dual Scimitars";
		RECIPE.requiredBeliefs = {"ingenious"};
		RECIPE.requiredBeliefsNiceNames = {"Ingenious"};
		RECIPE.requirements = {
			["begotten_1h_scimitar"] = {amount = 2},
		};
		RECIPE.result = {
			["begotten_dual_scimitars"] = {amount = 1},
		};
		RECIPE.category = "Weapons"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("dual_shards");
		RECIPE.name = "Dual Shards";
		RECIPE.requiredBeliefs = {"ingenious"};
		RECIPE.requiredBeliefsNiceNames = {"Ingenious"};
		RECIPE.requiredFaiths = {"Faith of the Dark"};
		RECIPE.requirements = {
			["begotten_1h_shard"] = {amount = 2},
		};
		RECIPE.result = {
			["begotten_dual_shards"] = {amount = 1},
		};
		RECIPE.category = "Weapons"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("dualdagger_kinisger");
		RECIPE.name = "Dual Kinisger Daggers";
		RECIPE.requiredBeliefs = {"ingenious"};
		RECIPE.requiredBeliefsNiceNames = {"Ingenious"};
		RECIPE.requiredFaiths = {"Faith of the Dark"};
		RECIPE.requiredFactions = {"Children of Satan"};
		RECIPE.requirements = {
			["begotten_dagger_housekinisgerancestraldagger"] = {amount = 2},
		};
		RECIPE.result = {
			["begotten_dualdagger_kinisger"] = {amount = 1},
		};
		RECIPE.category = "Weapons"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("dual_scrap_blades");
		RECIPE.name = "Dual Scrap Blades";
		RECIPE.requiredBeliefs = {"ingenious"};
		RECIPE.requiredBeliefsNiceNames = {"Ingenious"};
		RECIPE.requirements = {
			["begotten_1h_scrapblade"] = {amount = 2},
		};
		RECIPE.result = {
			["begotten_dual_scrapblades"] = {amount = 1},
		};
		RECIPE.category = "Weapons"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("gore_beserker_armor");
		RECIPE.name = "Gore Beserker Armor";
		RECIPE.requiredBeliefs = {"craftsman"};
		RECIPE.requiredBeliefsNiceNames = {"Craftsman"};
		RECIPE.requiredFactions = {"Goreic Warrior"};
		RECIPE.requirements = {

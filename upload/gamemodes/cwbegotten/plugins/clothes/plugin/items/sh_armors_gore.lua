...
ITEM.insulation = 70; -- Adds 56% insulation. Armor only accounts for 80% of total insulation, helmets cover the rest of the 20%.
...
ITEM.slashScale = 0.90; -- reduces slash damage by 10%
ITEM.stabilityScale = 0.50; -- reduces stability damage by 50%
ITEM.insulation = 80; -- Adds 64% insulation. Armor only accounts for 80% of total insulation, helmets cover the rest of the 20%.
...
ITEM.stabilityScale = 0.75; -- reduces stability damage by 25%
ITEM.bulletScale = 0.75; -- reduces bullet damage by 25%
ITEM.insulation = 80; -- Adds 48% insulation. Armor only accounts for 80% of total insulation, helmets cover the rest of the 20%.

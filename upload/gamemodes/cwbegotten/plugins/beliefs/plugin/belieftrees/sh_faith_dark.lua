	...
	DARK.beliefs = {
		[1] = {
			["embrace_the_darkness"] = {
				...
				description = "Enables the 'Cloaking' mechanic for use with Senses in the Wasteland at night, during bloodstorms, or while in the mines. Also unlocks Tier III 'Faith of the Dark' rituals if you are of the 'House Rekh-khet-sa' bloodline.",
		...
		[6] = {
			...
			["impossibly_skilled"] = {
				...
				subfaith = "Satanism",
				description = "Dual Weapons now block bullets, crossbow bolts, and javelins. Unlocks the ability to parry or deflect bolts and javelins to redirect them at your foe. Moderately increases parry and deflection windows for all melee weapons. Requires 'Blademaster' to also be unlocked.",
		...
		[8] = {
			...
			["assassin"] = {
				name = "Assassin",
				subfaith = "Satanism",
				description = "Stabbing someone with a dagger who is below 25% of their max health or who is fallen over will instantly kill them. Characters affected by such damage bonuses will be highlighted in red. The backstab bonus for daggers is increased from +200% to +300%. Also extinguishes 'Soulscorch'. Requires 'Swift' to also be unlocked.",

	...
	DARK.beliefs = {
		[1] = {
			["embrace_the_darkness"] = {
				...
				description = "Enables the 'Cloaking' mechanic for use with Senses in the Wasteland at night. Also unlocks Tier III 'Faith of the Dark' rituals if you are of the 'House Rekh-khet-sa' bloodline.",

...
local PROWESS = cwBeliefs.beliefTrees:New("prowess")
	...
	PROWESS.tooltip = {
		...
		{"\nBelief Tree Completion Bonus: +40% Inventory Capacity and +5% Melee Damage (Stacks w/ Other Buffs). Grants the ability to avoid dropping ragdolls when taking damage.", Color(50, 255, 50)}
	};
	...
	PROWESS.beliefs = {
		[1] = {
			...
			["blademaster"] = {
				name = "Blademaster",
				description = "All one handed slashing weapons and claws now deal 15% more damage. Unlocks the use of the 'Swordplay' attribute for longswords and arming swords.",

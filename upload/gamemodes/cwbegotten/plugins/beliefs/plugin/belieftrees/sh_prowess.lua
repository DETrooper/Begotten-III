...
local PROWESS = cwBeliefs.beliefTrees:New("prowess")
	...
	PROWESS.tooltip = {
		...
		{"\nBelief Tree Completion Bonus: +40% Inventory Capacity and +10% Melee Damage (Stacks w/ Other Buffs). Grants the ability to avoid dropping ragdolls when taking damage.", Color(50, 255, 50)}
	};

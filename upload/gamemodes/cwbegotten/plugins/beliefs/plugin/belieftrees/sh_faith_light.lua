	...
	LIGHT.beliefs = {
		[1] = {
			...
			["extinctionist"] = {
				name = "Extinctionist",
				subfaith = "Sol Orthodoxy",
				description = "Unlocks Tier III 'Faith of the Light' Rituals and unique Sol Orthodoxy Rituals. While on fire, your melee attacks will ignite any hit enemy even if they are blocking (not counting deflections/parries). Also unlocks the ability to warcry, which incurs corruption.",
				lockedFactions = {"Pope Adyssa's Gatekeepers", "Holy Hierarchy"},
				lockedSubfactions = {"Praeventor"},
		...
		[6] = {
			["the_light"] = {
				name = "The Light",
				subfaith = "Hard-Glazed",
				description = "Unlocks the ability to equip certain 'Faith of the Light' sacrificial weapons. All melee weapons, crossbow bolts, and javelins now deal 15% more armor-piercing damage.",

	...
	LIGHT.beliefs = {
		...
		[3] = {
			...
			["fanaticism"] = {
				name = "Fanaticism",
				subfaith = "Sol Orthodoxy",
				--description = "Increases melee, stamina, and stability damage by a maximum of 50% (at 10% health) the lower your health is.", (Incorporate this later)
				description = "Increases melee damage by a maximum of 50% (at 10% health) the lower your health is.",

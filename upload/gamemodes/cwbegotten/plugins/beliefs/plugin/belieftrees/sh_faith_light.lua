	...
	LIGHT.beliefs = {
		[1] = {
			["repentant"] = {
				...
				description = "Unlocks Tier I 'Faith of the Light' Rituals. Unlocks the ability to equip Sol Orthodoxy armors and sacrificial weapons, as well as the ability to dual-wield one-handed weapons weapons.",
		...
		[3] = {
			...
			["purity_afloat"] = {
				name = "Purity Afloat",
				subfaith = "Sol Orthodoxy",
				description = "Increases movement speed by a maximum of 15% (at 25% health) the lower your health is, but only when not wearing heavy armor.",
			...
			["fanaticism"] = {
				name = "Fanaticism",
				subfaith = "Sol Orthodoxy",
				description = "Increases melee, poise, and stability damage by a maximum of 40% (at 10% health) the lower your health is.",

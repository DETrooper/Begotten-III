	...
	FAMILY.beliefs = {
		...
		[3] = {
			...
			["daring_trout"] = {
				...
				subfaith = "Faith of the Old Son",
				description = "Upgrades the 'Warcry' ability: increases your melee armor piercing damage by 8 points for 20 seconds. Increases throwing axe damage by 15%. Unlocks Tier II Familial Rituals and unique Old Son rituals. If a member of Clan Harald, Ravens will now notify you if your Longship is under attack.",

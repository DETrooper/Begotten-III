	...
	FAMILY.beliefs = {
		[1] = {
			...
			["man_become_beast"] = {
				...
				subfaith = "Faith of the Father",
				description = "Unlocks the ability to dual-wield one-handed weapons. Unlocks the ability to equip claws. Increases maximum poise by 10 points. Increases maximum HP by 40 points. Unlocks Tier II Familial Rituals.",
				lockedSubfactions = {"Clan Harald", "Clan Reaver", "Clan Shagalax", "Clan Crast"},

	...
	FAMILY.beliefs = {
		...
		[4] = {
			...
			["shieldwall"] = {
				name = "Shieldwall",
				subfaith = "Faith of the Young Son",
				description = "Increases maximum HP by 25 points. Removes weapon damage penalty from using shields entirely. Increases stamina resistance of all shields by 15%.",

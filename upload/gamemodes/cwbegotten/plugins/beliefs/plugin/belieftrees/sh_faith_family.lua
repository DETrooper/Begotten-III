	...
	FAMILY.beliefs = {
		[1] = {
			...
			["fearsome_wolf"] = {
				...
				subfaith = "Faith of the Father",
				description = "Upgrades the 'Warcry' ability: all nearby foes will be highlighted in red for 20 seconds. You will deal 20% more damage and 15% more stamina damage against highlighted foes, as well as sprint 10% faster for a 20 second duration.",

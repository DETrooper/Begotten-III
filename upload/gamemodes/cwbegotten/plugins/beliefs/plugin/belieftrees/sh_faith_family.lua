	...
	FAMILY.beliefs = {
		[1] = {
			...
			["fearsome_wolf"] = {
				...
				description = "Upgrades the 'Warcry' ability: you will deal 20% more damage and 15% more stamina damage against nearby foes (including NPCs), as well as sprint 10% faster for a 20 second duration. Also increases throwing axe damage by 15%.",
		...
		[2] = {
			...
			["watchful_raven"] = {
				...
				subfaith = "Faith of the Mother",
				description = "Upgrades the 'Warcry' ability: Highlights all nearby friendlies (characters who recognise you) in green for 10 seconds and increases your own and their sanity and stamina by 10 points, as well as providing 10% damage resistance. Unlocks Tier III Familial Rituals and unique Mother rituals. Unlocks the ability to Ravenspeak if you are a Clan Crast Goreic Warrior. Reduces the chance of receiving injuries by 50%.",
				lockedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Shagalax"},
		...
		[3] = {
			...
			["daring_trout"] = {
				...
				subfaith = "Faith of the Old Son",
				--description = "Upgrades the 'Warcry' ability: all nearby foes will be highlighted in white for 10 seconds and will be slowed down by 15%. Increases throwing axe damage by 15%. Unlocks Tier II Familial Rituals and unique Old Son rituals. If a member of Clan Harald, Ravens will now notify you if your Longship is under attack.",
				description = "Upgrades the 'Warcry' ability: all nearby foes will be slowed down by 15% for 10 seconds. Increases throwing axe damage by 15%. Unlocks Tier II Familial Rituals and unique Old Son rituals. If a member of Clan Harald, Ravens will now notify you if your Longship is under attack.",
		...
		[5] = {
			...
			["shedskin"] = {
				name = "Shedskin",
				subfaith = "Faith of the Sister",
				description = "Increases maximum health by 20 points. Increases protection value of all armor by 15%. Unlocks Tier II Faith of the Family and Faith of the Dark rituals, as well as unique Sister rituals.",
			...
			["deceitful_snake"] = {
				...
				subfaith = "Faith of the Sister",
				description = "If someone deals 10 or more points of damage to you in a single blow, they will be highlighted in red and receive 25% more damage from you for 40 seconds. Also unlocks the ability to smelt Hellforged Steel (only if 'Master Blacksmith' is also unlocked).",

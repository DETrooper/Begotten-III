	...
	FAMILY.beliefs = {
		[1] = {
			...
			["fearsome_wolf"] = {
				...
				description = "Upgrades the 'Warcry' ability: you will deal 20% more damage and 15% more stamina damage against all nearby players and NPCs, as well as sprint 10% faster for a 20 second duration. Also increases throwing axe damage by 15%.",
		...
		[5] = {
			...
			["deceitful_snake"] = {
				...
				subfaith = "Faith of the Sister",
				description = "Upgrades the 'Warcry' ability: restores half of all HP lost within the last 2 seconds. If someone deals 10 or more points of damage to you in a single blow, they will be highlighted in red and receive 25% more damage from you for 40 seconds. Also unlocks the ability to smelt Hellforged Steel (only if 'Master Blacksmith' is also unlocked).",

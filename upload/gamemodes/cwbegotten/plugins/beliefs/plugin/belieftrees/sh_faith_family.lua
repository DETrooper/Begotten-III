	...
	FAMILY.beliefs = {
		...
		[2] = {
			...
			["watchful_raven"] = {
				...
				subfaith = "Faith of the Mother",
				description = "Unlocks Tier III Familial Rituals and unique Mother rituals. Unlocks the ability to Ravenspeak if you are a Clan Crast Goreic Warrior. Reduces the chance of receiving injuries by 50%. Unlocks unique alchemy recipes.",
				lockedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Shagalax"},
		...
		[3] = {
			...
			["daring_trout"] = {
				...
				subfaith = "Faith of the Old Son",
				description = "Upgrades the 'Warcry' ability: all nearby foes will be highlighted in white for 10 seconds and will be slowed down by 15%. Increases throwing axe damage by 15%. Unlocks Tier II Familial Rituals and unique Old Son rituals.",

	...
	if not cwItemSpawner.ContainerLocations then
		cwItemSpawner.ContainerLocations = {
			["city"] = {
				...
				{model = "models/props_wasteland/controlroom_filecabinet001a.mdl", pos = Vector(-3647.21875, -7356.125, -1102.90625), angles = Angle(0, 90, 0)},
				{model = "models/props_wasteland/controlroom_filecabinet001a.mdl", pos = Vector(-3647.21875, -7356.125, -1231), angles = Angle(0, 90, 0)},
				{model = "models/props_wasteland/controlroom_filecabinet001a.mdl", pos = Vector(-3647.21875, -7356.125, -1359), angles = Angle(0, 90, 0)},

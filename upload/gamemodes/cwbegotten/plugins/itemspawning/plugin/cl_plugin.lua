...
config.AddToSystem("Loot Player Ratio", "loot_player_ratio", "Percentage of players active for when loot spawns will be maxxed (default value of 75% is 60 out of 80 for example).", 0.1, 1);

...
local FACTION = Clockwork.faction:New("Pope Adyssa's Gatekeepers");
	...
	function FACTION:GetName(player, character)
		return "GATEKEEPER-DISCIPLE."..Clockwork.kernel:ZeroNumberToDigits(math.random(1, 99999), 5);
	end;

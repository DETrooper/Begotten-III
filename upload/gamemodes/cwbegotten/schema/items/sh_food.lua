local ITEM = Clockwork.item:New();
	...
	ITEM.itemSpawnerInfo = {category = "Food", rarity = 950};
...
local ITEM = Clockwork.item:New();
	...
	ITEM.category = "Food";
	ITEM.useSound = "npc/barnacle/barnacle_crunch2.wav";
	ITEM.description = "A punctured tin can with what used to be mushroom soup inside. Now a soupy mix of maggots, mould and disease. Hey, at least it's something to fill your belly.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/can_punctured.png"
	ITEM.stackable = true;
	ITEM.infectionchance = 50;
	ITEM.poison = 6;
	
	ITEM.itemSpawnerInfo = {category = "Food", rarity = 750};

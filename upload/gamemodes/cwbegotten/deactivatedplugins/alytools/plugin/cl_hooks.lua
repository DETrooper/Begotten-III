				...
				if istable(markeddata) and range > 32 then
					if IsValid(markeddata.entity) then
						...
						if not hidedata then
							...
							draw.DrawText(string.utf8upper(zone), "DermaDefault", textply2.x+170, textply2.y+7, Color(0,255,0,alpha), TEXT_ALIGN_LEFT)
					...
					elseif markeddata.valid then
						...
						if not hidedata then
							...
							draw.DrawText(string.utf8upper(zone), "DermaDefault", textply2.x+170, textply2.y-23, Color(0,255,0,alpha), TEXT_ALIGN_LEFT)

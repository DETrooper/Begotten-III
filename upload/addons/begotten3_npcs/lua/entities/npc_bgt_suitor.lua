...
ENT.Models = {"models/begotten/thralls/suitor.mdl"}
...
if SERVER then
	...
	function ENT:CustomInitialize()
		...
		self:EmitSound("weapons/chainsaw/chainsaw_start_0"..tostring(math.random(1, 2))..".wav", 75, 100, 0.75);
	end
	-- AI --
	...
	function ENT:OnDeath(dmg, delay, hitgroup)
		self:EmitSound("weapons/chainsaw/chainsaw_die_01.wav");
	end
	...
	function ENT:CustomThink()
		...
		if (!entity.cwChainsawSound) then
			...
			entity.cwChainsawSound = CreateSound(entity, "weapons/chainsaw/chainsaw_idle_lp_01.wav", rf);
		...
		if (self:HasEnemy()) then
			if !self.aggravated then
				...
				entity.cwChainsawSound = CreateSound(entity, "weapons/chainsaw/chainsaw_high_speed_lp_01.wav", rf);
				entity.cwChainsawSound:PlayEx(0.75, math.random(95, 105));

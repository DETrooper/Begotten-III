...
function ENT:OnLost()
  ...
  function ENT:CustomInitialize()
	...
	self.gri = cwParts:HandleClothing(self, "models/monk.mdl", 9, 0, true);
	self.gri:SetMaterial("models/undead/poisonzombie_sheet")
	cwParts:HandleClothing(self, "models/undead/fast.mdl", 0, 0, true);
	cwParts:HandleClothing(self, "models/undead/poison.mdl", 4, 0, true);
	self.skele = cwParts:HandleClothing(self, "models/skeleton/skeleton_torso.mdl", 8, 2, true);
	self.skele:SetMaterial("models/undead/charple4_sheet")
	self.kni = cwGear:HandleGear(self, "models/props_c17/TrapPropeller_Blade.mdl", "right hand", Vector(0, -1, 0), Angle(0, 0, 180), 0.5);
	self.kni:SetMaterial("models/undead/poisonzombie_sheet")

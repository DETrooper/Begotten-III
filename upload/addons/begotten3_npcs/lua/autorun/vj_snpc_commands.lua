...
AddConvars["vj_npc_noproppush"] = 1 -- Disable SNPCs pushing props
AddConvars["vj_npc_nopropattack"] = 1 -- Disable SNPCs attacking props
	-- Human Settings ----------------------------------------------------------------------------------------------------
...
AddConvars["vj_npc_corpsefade"] = 1 -- Make Corpses fade
AddConvars["vj_npc_corpsefadetime"] = 500 -- Time until Corpses fade
...
AddConvars["vj_npc_sd_callforhelp"] = 0 -- Disable call for help sounds
AddConvars["vj_npc_sd_onreceiveorder"] = 0 -- Disable on receive order sounds (Ex: When called to come help an ally)
...
AddConvars["vj_npc_sd_suppressing"] = 0 -- Disable suppressing callout sounds
---------------------------------------------------------------------------------------------------------------------------
-- Developer Settings --

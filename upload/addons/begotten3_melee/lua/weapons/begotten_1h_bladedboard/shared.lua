...
SWEP.VElements = {
	["v_bladedboard"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/board.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.099, -0.201, 11.947), angle = Angle(8.182, -75.974, 180), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {[0] = 3} }
}

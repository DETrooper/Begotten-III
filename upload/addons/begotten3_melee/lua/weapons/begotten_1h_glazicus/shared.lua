...
SWEP.BlockTable = "GlazicusBlockTable"
...
SWEP.WElementsDual = {
	["w_left"] = { type = "Model", model = "models/demonssouls/weapons/broad sword.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(2.595, 1.557, 0.977), angle = Angle(70, -87.695, -180), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} },
	["w_right"] = { type = "Model", model = "models/demonssouls/weapons/broad sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.595, 1.557, 0.977), angle = Angle(-70, 90, -176.495), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
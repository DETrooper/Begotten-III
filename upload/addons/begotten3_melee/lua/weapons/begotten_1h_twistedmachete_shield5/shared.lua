...
SWEP.PrintName = "Twisted Machete + Wooden Shield"
...
SWEP.IronSightsPos = Vector(11.96, -7.035, 5.4)
SWEP.IronSightsAng = Vector(-3.518, 1.406, 0.703)
...
SWEP.VElements = {
	["v_shield5"] = { type = "Model", model = "models/skyrim/shield_stormcloaks.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-1.558, -14.027, 2.596), angle = Angle(-146.105, 71.299, -106.364), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },

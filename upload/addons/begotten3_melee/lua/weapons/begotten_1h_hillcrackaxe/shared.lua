...
SWEP.WElements = {
	["w_hillcrackaxe"] = { type = "Model", model = "models/begotten_apocalypse/items/DawnstarAxe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2, -1.2), angle = Angle(90, 90, -25), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
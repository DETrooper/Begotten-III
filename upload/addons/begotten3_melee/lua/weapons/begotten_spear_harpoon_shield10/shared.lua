...
SWEP.PrintName = "Harpoon + Gore Guardian Shield"
...
SWEP.IronSightsPos = Vector(2.64, -8.242, -0.08)
SWEP.IronSightsAng = Vector(9.848, 0.703, -16.181)
...
SWEP.VElements = {
	...
	["v_shield10"] = { type = "Model", model = "models/demonssouls/shields/large brushwood shield.mdl", bone = "ValveBiped.Bip01_L_Forearm", rel = "", pos = Vector(15.064, -0.519, -0.519), angle = Angle(61.948, 80.649, -15.195), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.WElements = {
	...
	["w_shield10"] = { type = "Model", model = "models/demonssouls/shields/large brushwood shield.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(0.518, 1.557, -0.519), angle = Angle(-97.5, 50, -160), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
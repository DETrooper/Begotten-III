...
SWEP.PrintName = "Iron Rapier + Gatekeeper Shield"
...
SWEP.IronSightsPos = Vector(10.8, -8.643, 4.159)
...
SWEP.VElements = {
	...
	["v_shield11"] = { type = "Model", model = "models/props/begotten/melee/twin_dragon_greatshield.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-5.715, 1.557, 4.675), angle = Angle(178.83, -132.079, -36.235), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

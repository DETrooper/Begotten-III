...
-- WEAPON TYPE: One Handed (Unique)

SWEP.PrintName = "Blackclaw"
SWEP.Category = "(Begotten) Unique"
...
SWEP.CriticalAnim = "a_sword_attack_slash_slow_02"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "BlackclawAttackTable"
SWEP.BlockTable = "BlackclawBlockTable"

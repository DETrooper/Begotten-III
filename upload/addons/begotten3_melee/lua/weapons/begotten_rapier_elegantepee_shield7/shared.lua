...
SWEP.PrintName = "Elegant Epee + Knight's Shield"
...
SWEP.IronSightsPos = Vector(3.24, -7.437, 3.079)
SWEP.IronSightsAng = Vector(-3, -15, -3.901)
...
SWEP.VElements = {
	...
	["v_shield7"] = { type = "Model", model = "models/demonssouls/shields/knight's shield.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.675, -7.792, 8.831), angle = Angle(-155.456, -47.923, -170), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

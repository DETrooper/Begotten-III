...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "DualScimitarsAttackTable"
SWEP.BlockTable = "DualScimitarsBlockTable"
...
---------------------------------------------------------*/
SWEP.VElements = {
	["v_swordleft"] = { type = "Model", model = "models/demonssouls/weapons/scimitar.mdl", bone = "Dummy16", rel = "", pos = Vector(0, -9, -0.201), angle = Angle(1.169, 80.649, -180), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["v_swordright"] = { type = "Model", model = "models/demonssouls/weapons/scimitar.mdl", bone = "Dummy01", rel = "", pos = Vector(0.25, -12, 0.5), angle = Angle(3.506, 73.636, -169.482), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_scimitar_1"] = { type = "Model", model = "models/demonssouls/weapons/scimitar.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.557, 0), angle = Angle(-70, 90, -176.495), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["w_scimitar_2"] = { type = "Model", model = "models/demonssouls/weapons/scimitar.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(2.9, 0.899, -0.5), angle = Angle(105, 90, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
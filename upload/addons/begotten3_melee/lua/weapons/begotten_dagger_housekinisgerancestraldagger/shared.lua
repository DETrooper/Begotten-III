...
SWEP.PrintName = "House Kinisger Ancestral Dagger"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "Ancestraldagger_Kinisger_AttackTable"
SWEP.BlockTable = "Ancestraldagger_Kinisger_BlockTable"

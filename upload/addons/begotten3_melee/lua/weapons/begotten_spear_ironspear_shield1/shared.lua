...
SWEP.WElements = {
	...
	["shield1_spear_goreic_pt2"] = { type = "Model", model = "models/demonssouls/shields/leather shield.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "shield1", pos = Vector(-1.351, -2.5, 6.9), angle = Angle(-1.17, 90, -87.663), size = Vector(0.649, 0.649, 0.649), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["shield1_spear_goreic_pt11"] = { type = "Model", model = "models/items/weapons/arrows/arrow_explosive.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "shield1", pos = Vector(14.026, -7.792, 9.869), angle = Angle(-12.858, -157.793, 0), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["shield1_spear_goreic_pt1"] = { type = "Model", model = "models/demonssouls/shields/wooden shield.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "shield1", pos = Vector(0.2, -0.519, 2.596), angle = Angle(-1.17, 90, -78.312), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["shield1_spear_goreic_pt10"] = { type = "Model", model = "models/items/weapons/arrows/arrow_explosive.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "shield1", pos = Vector(14.026, 10.909, -0.519), angle = Angle(5.843, 155.455, 0), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["shield1_spear_goreic_pt5"] = { type = "Model", model = "", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },

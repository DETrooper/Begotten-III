...
SWEP.PrintName = "Elegant Epee + Gore Guardian Shield"
...
SWEP.IronSightsPos = Vector(5.079, -3.82, -0.361)
SWEP.IronSightsAng = Vector(8.442, -0.704, -12.664)
...
SWEP.VElements = {
	...
	["v_shield10"] = { type = "Model", model = "models/demonssouls/shields/large brushwood shield.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-4.676, -0.519, 5.714), angle = Angle(-139.092, -57.273, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

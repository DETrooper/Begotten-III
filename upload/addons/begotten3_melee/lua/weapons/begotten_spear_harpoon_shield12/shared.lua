...
SWEP.PrintName = "Harpoon + Warfighter Shield"
...
SWEP.IronSightsPos = Vector(9.8, 0, 4.8)
SWEP.IronSightsAng = Vector(-10.554, -12.664, 13.366)
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "HarpoonAttackTable"
...
SWEP.VElements = {
	...
	["v_shield12"] = { type = "Model", model = "models/props/begotten/melee/pursuer_greatshield.mdl", bone = "ValveBiped.Bip01_L_Forearm", rel = "", pos = Vector(12, 7, 5), angle = Angle(-140, -30, -80), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

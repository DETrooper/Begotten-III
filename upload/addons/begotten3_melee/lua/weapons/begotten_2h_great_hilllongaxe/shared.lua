...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "HillHeavyBattleAxeAttackTable"
SWEP.BlockTable = "HillHeavyBattleAxeBlockTable"
...
SWEP.VElements = {
	["v_hilllongaxe"] = { type = "Model", model = "models/begotten_apocalypse/items/2HAxe2.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.151, 0.129, -1.3), angle = Angle(-90, -120, -110), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_hilllongaxe"] = { type = "Model", model = "models/begotten_apocalypse/items/2HAxe2.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.9, 0.8, 15.595), angle = Angle(-90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.PrintName = "Iron Shortsword"
...
SWEP.BlockTable = "ShortswordBlockTable"
...
SWEP.VElements = {
	["v_shortsword"] = { type = "Model", model = "models/demonssouls/weapons/short sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.99, 1.5, 0.949), angle = Angle(-80.65, -8.183, 71.299), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_shortsword"] = { type = "Model", model = "models/demonssouls/weapons/short sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.5, 0.5), angle = Angle(-80.65, 66.623, -15.195), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.VElementsDual = {
	["v_left"] = { type = "Model", model = "models/demonssouls/weapons/short sword.mdl", bone = "Dummy16", rel = "", pos = Vector(0, -8.886, -0.1), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} },
	["v_right"] = { type = "Model", model = "models/demonssouls/weapons/short sword.mdl", bone = "Dummy01", rel = "", pos = Vector(0.5, -11.886, 0.5), angle = Angle(0, 90, 10), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElementsDual = {
	["w_left"] = { type = "Model", model = "models/demonssouls/weapons/short sword.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(2.595, 1.157, 0), angle = Angle(110, 120, -176.495), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} },
	["w_right"] = { type = "Model", model = "models/demonssouls/weapons/short sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.5, 0.5), angle = Angle(-70.65, 86.623, -15.195), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
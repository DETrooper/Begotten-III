...
SWEP.PrintName = "Elegant Epee + Clan Shield"
...
SWEP.IronSightsPos = Vector(8.079, -5.428, 1.6)
SWEP.IronSightsAng = Vector(3.517, -10.9, -6.332)
...
SWEP.VElements = {
	...
	["v_shield14"] = { type = "Model", model = "models/begotten/weapons/goreroundshield.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-1.558, -7.792, 5.714), angle = Angle(174.156, -136.754, -122.727), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

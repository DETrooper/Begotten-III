...
SWEP.PrintName = "Harpoon + Buckler"
...
SWEP.IronSightsPos = Vector(0.959, -4.222, 2.68)
SWEP.IronSightsAng = Vector(0, -7.035, -16.181)
...
SWEP.VElements = {
	...
	["v_shield4"] = { type = "Model", model = "models/demonssouls/shields/buckler.mdl", bone = "ValveBiped.Bip01_L_Forearm", rel = "", pos = Vector(19.221, 5.714, 1.557), angle = Angle(71.299, 90, -24.546), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

...
SWEP.PrintName = "Elegant Epee + Wooden Shield"
...
SWEP.IronSightsPos = Vector(8.96, -7.639, 2.279)
SWEP.IronSightsAng = Vector(-4.222, -1.407, -4.926)
...
SWEP.VElements = {
	...
	["v_shield5"] = { type = "Model", model = "models/skyrim/shield_stormcloaks.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.675, -7.792, 4.675), angle = Angle(-139.092, -45.584, 178.83), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

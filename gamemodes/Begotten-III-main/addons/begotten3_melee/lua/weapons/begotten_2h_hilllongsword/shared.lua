...
SWEP.PrintName = "Hill Yeoman Longsword"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "HillLongswordAttackTable"
SWEP.BlockTable = "HillLongswordBlockTable"
...
SWEP.VElements = {
	["v_hilllongsword"] = { type = "Model", model = "models/begotten_apocalypse/items/IronClaymore.mdl", bone = "RW_Weapon", rel = "", pos = Vector(.5, 0.5, 2.557), angle = Angle(-90, -40, 90), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_hilllongsword"] = { type = "Model", model = "models/begotten_apocalypse/items/IronClaymore.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1, 0.596), angle = Angle(85, 90, 10), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
local DATA = {}
DATA.Name = "begotten_1h"
DATA.HoldType = "wos-begotten_1h"
...
DATA.Translations[ ACT_COVER_LOW ] = {
	{ Sequence = "a_sword_crouch_idle", Weight = 1 },
}

DATA.Translations[ ACT_WALK_CROUCH ] = {
	{ Sequence = "a_sword_crouch_walk", Weight = 1 },
}

-- Idle
DATA.Translations[ ACT_IDLE_ANGRY_MELEE ] = {
	{ Sequence = "a_sword_unholstered_idle", Weight = 1 },
}
...
DATA.Translations[ ACT_WALK_AIM_RIFLE ] = {
	{ Sequence = "a_sword_unholstered_walk", Weight = 1 },
}
...
DATA.Translations[ ACT_RUN_AIM_RIFLE_STIMULATED ] = {
	{ Sequence = "a_sword_unholstered_run", Weight = 1 },
}

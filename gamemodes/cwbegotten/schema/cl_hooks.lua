			...
			if weaponStats["attack"] and weaponStats["defense"] then
				...
				if itemTable.attributes then
					if table.HasValue(itemTable.attributes, "last_stand") then
						frame:AddText("Unholy Blessing: Upon reaching 40% of your maximum health, this weapon will become imbued with either fire or ice, and will deal elemental damage.", Color(110, 30, 30), nil, 0.9);
					end

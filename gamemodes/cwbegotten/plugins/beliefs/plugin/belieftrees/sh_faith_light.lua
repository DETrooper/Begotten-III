...
local LIGHT = cwBeliefs.beliefTrees:New("light")
	...
	LIGHT.lockedSubfactions = {"Clan Grock", "Clan Gotnarh"};
	...
	LIGHT.beliefs = {
		[1] = {
			["repentant"] = {
				...
				lockedSubfactions = {"Praeventor", "Northlander", "Order Of The Writ", "Prole of The Writ"},
			...
			["flagellant"] = {
				...
				requirements = {"sol_orthodoxy", "repentant", "Order Of The Writ", "Prole of The Writ"},
				row = 3,
			},
			["extinctionist"] = {
				name = "Extinctionist",
				...
				lockedFactions = {"Pope Adyssa's Gatekeepers", "Holy Hierarchy"},
				lockedSubfactions = {"Praeventor", "Northlander"},
				requirements = {"sol_orthodoxy", "repentant", "flagellant", "Order Of The Writ", "Prole of The Writ"},
				row = 4,
			},
		},
		[2] = {
		...
		[3] = {
			["prison_of_flesh"] = {
				...
				subfaith = "Sol Orthodoxy",
				description = "Taking fire damage will reduce Corruption by each point of damage taken. If possessed, corruption will not be reduced until it is above 50%.",
		...
		[6] = {
			...
			["blessed_powder"] = {
				name = "Blessed Powder",
				subfaith = "Hard-Glazed",
				description = "All firearms now deal 30% more damage.",
			...
			["manifesto"] = {
				...
				subfaith = "Hard-Glazed",
				description = "You now deal 20% more damage with any weapon except a firearm against characters of another Faith, but deal 10% less damage against those of the same Faith. Replaces the effect of the 'Grounded' attribute on melee weapons to do 60% less melee damage while sprinting instead of disallowing melee attacks while sprinting outright.",
		...
		[7] = {
			["wire_therapy"] = {
				...
				lockedFactions = {"Pope Adyssa's Gatekeepers", "Gatekeeper", "Militant Orders of the Villa", "Hillkeeper", "Holy Hierarchy", "Aristocracy Of Light"},

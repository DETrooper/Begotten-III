	...
	LIGHT.beliefs = {
		[1] = {
			["repentant"] = {
				...
				lockedSubfactions = {"Praeventor", "Northlander", "Order Of The Writ"},
			...
			["flagellant"] = {
				...
				requirements = {"sol_orthodoxy", "repentant", "Order Of The Writ"},
				row = 3,
			},
			["extinctionist"] = {
				name = "Extinctionist",
				...
				lockedFactions = {"Pope Adyssa's Gatekeepers", "Holy Hierarchy"},
				lockedSubfactions = {"Praeventor", "Northlander"},
				requirements = {"sol_orthodoxy", "repentant", "flagellant", "Order Of The Writ"},
				row = 4,
			},
		},
		[2] = {

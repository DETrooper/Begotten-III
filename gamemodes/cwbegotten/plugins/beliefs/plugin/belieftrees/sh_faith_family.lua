	...
	FAMILY.beliefs = {
		...
		[2] = {
			...
			["gift_great_tree"] = {
				...
				subfaith = "Faith of the Mother",
				description = "You will now passively regenerate health over time, irrespective of your wounds, though still affected by sepsis. This is separate from normal health regeneration and much faster. Increases your maximum HP by 25 points.",

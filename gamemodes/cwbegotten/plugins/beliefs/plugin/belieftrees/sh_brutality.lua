...
local BRUTALITY = cwBeliefs.beliefTrees:New("brutality")
	...
	BRUTALITY.tooltip = {
		...
		{"\nBelief Tree Completion Bonus: Killing another character instantly restores 2.5% of your Health, Stamina, and Stability per sacrament level of the character.", Color(50, 255, 50)}
	};

	...
	DARK.beliefs = {
		...
		[2] = {
			...
			["soothsayer"] = {
				name = "Soothsayer",
				subfaith = "Primevalism",
				description = "Unlocks Tier I and Tier II 'Faith of the Dark' Rituals. Also unlocks the ability to darkwhisper, as well as the ability to use Tripwires. Bear Traps will now deploy 20% faster.",
			...
			["survivalist"] = {
				name = "Survivalist",
				subfaith = "Primevalism",
				description = "All pierce melee weapons and throwables as well as crossbow bolts now apply poison which lowers the target's movement speed and slowly drains health. Also unlocks the 'Echolocation' ability, activated by war crying in the Wasteland at night, during bloodstorms, or while in the mines. Your warcry will cause lanterns to burn out, and allow you to see a mirage of distant people through walls.",

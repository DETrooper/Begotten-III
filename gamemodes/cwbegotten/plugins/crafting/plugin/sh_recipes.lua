...
function cwRecipes:ClockworkInitialized()
	...
	RECIPE = cwRecipes.recipes:New("quickshank");
		...
		RECIPE.requiredBeliefs = {"ingenious"};
		RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock", "Clan Gotnarh"};
		RECIPE.requirements = {
			["scrap"] = {amount = 1},
			["wood"] = {amount = 1},
		};
	...
	RECIPE = cwRecipes.recipes:New("wooden_crossbow");
		...
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"mechanic"};
		RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Grock", "Clan Gotnarh"};
		RECIPE.requirements = {
			["bindings"] = {amount = 1},
			["iron_ingot"] = {amount = 2},
			["wood"] = {amount = 3},
	...
	RECIPE = cwRecipes.recipes:New("pop_a_shot");
		...
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"craftsman"};
		RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Gotnarh"};
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 1},
			["gunpowder"] = {amount = 1},
		};
	...
	RECIPE = cwRecipes.recipes:New("iron_bolt");
		...
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"craftsman"};
		RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Gotnarh"};
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 1},
			["wood"] = {amount = 3},
		};

...
function PANEL:SetMirrored(bMirrored)
	self.mirrored = bMirrored;
end
...
function PANEL:PaintAt( x, y, dw, dh )
	...
	if ( self:GetKeepAspect() ) then
		...
		if self.mirrored then
			surface.DrawTexturedRectUV( OffX + x, OffY + y, w, h, 1, 0, 0, 1 )
		else
	...
	if self.mirrored then
		surface.DrawTexturedRectUV( x, y, dw, dh, 1, 0, 0, 1 )
	else

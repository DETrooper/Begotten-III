...
SWEP.VElements = {
	["jezail"] = { type = "Model", model = "models/sw_battlefront/weapons/jezail_short.mdl", bone = "v_ee3_reference001", rel = "", pos = Vector(0.2, -2, 1.5), angle = Angle(0, 0, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["cycler"] = { type = "Model", model = "models/sw_battlefront/weapons/jezail_short.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1, -1.201), angle = Angle(180, 90, -8), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.Gun = ("begotten_jezail_short") -- must be the name of your swep but NO CAPITALS!
SWEP.Category				= "Begotten"
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.MuzzleAttachment			= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment			= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "Short Jezail"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Damage		= 90	//base damage, scaled by game
...
SWEP.AmmoTypes = {
	["Longshot"] = function(SWEP)
		...
		SWEP.Primary.FarSound = Sound("v51_"..math.random(1,4).."_distant.mp3");

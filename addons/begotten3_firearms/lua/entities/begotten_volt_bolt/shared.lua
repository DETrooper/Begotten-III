...
if SERVER then
	...
	function ENT:Initialize()
		...
		if IsValid(self.tesla) then
			...
			self.tesla:SetKeyValue("m_flRadius", "15")
			self.tesla:SetKeyValue("beamcount_min", "1")
			self.tesla:SetKeyValue("beamcount_max", "2")
			self.tesla:SetKeyValue("thick_min", "0.2")
			self.tesla:SetKeyValue("thick_max", "0.4")
			self.tesla:SetKeyValue("lifetime_min", "0.03")
			self.tesla:SetKeyValue("lifetime_max", "0.07")
			self.tesla:SetKeyValue("interval_min", "0.1")
			self.tesla:SetKeyValue("interval_max", "0.15")
			self.tesla:SetKeyValue("texture", "sprites/physbeam.vmt")
			self.tesla:SetKeyValue("m_Color", "0 200 255")
			self.tesla:Spawn()
			self.tesla:Activate()
			self.tesla:Fire("TurnOn", "", 0)
		end

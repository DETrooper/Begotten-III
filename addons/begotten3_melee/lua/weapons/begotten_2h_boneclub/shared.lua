...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "BoneClubAttackTable"
SWEP.BlockTable = "BoneClubBlockTable"
...
SWEP.VElements = {
	["v_boneclub"] = { type = "Model", model = "models/weapons/bonehammer.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, -3.458), angle = Angle(-3.333, 0, 0), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_boneclub"] = { type = "Model", model = "models/weapons/bonehammer.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.443, 0.493, 2.469), angle = Angle(-10, 92.222, 16.666), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} }
}
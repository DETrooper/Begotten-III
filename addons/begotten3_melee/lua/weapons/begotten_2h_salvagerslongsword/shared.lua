...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "SalvagersLongswordAttackTable"
SWEP.BlockTable = "SalvagersLongswordBlockTable"
...
SWEP.VElements = {
	["v_sallongsword"] = { type = "Model", model = "models/newvegasprops/bumpsword.mdl", bone = "RW_Weapon", rel = "",  pos = Vector(0.493, 1.48, -8.396), angle = Angle(-94.445, 92.222, 41.111), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_sallongsword"] = { type = "Model", model = "models/newvegasprops/bumpsword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.457, -0.494, 11.357), angle = Angle(81.111, 107.777, -21.112), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "FlambergeAttackTable"
SWEP.BlockTable = "FlambergeBlockTable"
...
SWEP.VElements = {
	["v_flamberg"] = { type = "Model", model = "models/demonssouls/weapons/flamberge.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0.5, 6), angle = Angle(82.986, 0, 57.272), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_flamberg"] = { type = "Model", model = "models/demonssouls/weapons/flamberge.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1, -2), angle = Angle(-97.014, 73.636, -162.469), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
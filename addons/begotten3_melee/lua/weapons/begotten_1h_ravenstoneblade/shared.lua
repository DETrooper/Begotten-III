...
SWEP.PrintName = "Ravenstone Blade"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "RavenstoneBladeAttackTable"
SWEP.BlockTable = "RavenstoneBladeBlockTable"
...
SWEP.VElements = {
	["v_ravenstoneblade"] = { type = "Model", model = "models/weapons/cultistblade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.99, 1.299, 0.518), angle = Angle(-11.9, -94.444, -174.157), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_ravenstoneblade"] = { type = "Model", model = "models/weapons/cultistblade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.25, 0.518), angle = Angle(-174.444, 63.333, 7.778), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.VElementsDual = {
	["v_left"] = { type = "Model", model = "models/weapons/cultistblade.mdl", bone = "Dummy16", rel = "", pos = Vector(0, -6.886, -0.1), angle = Angle(-118.889, 0, -90), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} },
	["v_right"] = { type = "Model", model = "models/weapons/cultistblade.mdl", bone = "Dummy01", rel = "", pos = Vector(0.5, -9.886, 0.5), angle = Angle(-118.889, 0, -90), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElementsDual = {
	["w_left"] = { type = "Model", model = "models/weapons/cultistblade.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(2.6, 0.6, -1), angle = Angle(10.519, 101.111, -10.52), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} },
	["w_right"] = { type = "Model", model = "models/weapons/cultistblade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.25, -0.5), angle = Angle(-154.444, 76.667, 5.556), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
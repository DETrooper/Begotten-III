...
SWEP.PrintName = "Grockling Stone Blade"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "GrocklingSwordAttackTable"
SWEP.BlockTable = "GrocklingSwordBlockTable"
...
SWEP.VElements = {
	["v_grocklingsword"] = { type = "Model", model = "models/begotten/weapons/grocklingsword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.359, 0.5, -5.714), angle = Angle(-3.507, 61.948, 1.169), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_grocklingsword"] = { type = "Model", model = "models/begotten/weapons/grocklingsword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 0.699, 8.423), angle = Angle(-3.507, 241.948, -180), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
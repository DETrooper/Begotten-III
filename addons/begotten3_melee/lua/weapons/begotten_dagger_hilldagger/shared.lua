...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "HillGoreHuntingDaggerAttackTable"
SWEP.BlockTable = "HillGoreHuntingDaggerBlockTable"
...
SWEP.VElements = {
	["v_gorehuntingdagger"] = { type = "Model", model = "models/begotten_apocalypse/items/GuardDagger.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.5, 1.8, -.5), angle = Angle(90.495, 64.286, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

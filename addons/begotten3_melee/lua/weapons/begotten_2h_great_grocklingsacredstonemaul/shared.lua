...
SWEP.VElements = {
	["v_grocklingstonemaul"] = { type = "Model", model = "models/begotten/weapons/2h_mace3.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.59, -0.7, -7), angle = Angle(10.519, 85, 1.5), size = Vector(0.899, 0.899, 0.899), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_grocklingstonemaul"] = { type = "Model", model = "models/begotten/weapons/2h_mace3.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.635, 1, 5.714), angle = Angle(171.817, 3.5, -176.495), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
...
SWEP.PrintName = "Greaser Blockhammer"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "GreaserBlockhammerAttackTable"
SWEP.BlockTable = "GreaserBlockhammerBlockTable"
...
SWEP.VElements = {
	["v_greaserblockhammer"] = { type = "Model", model = "models/newvegasprops/supersledge.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-5.591, 9.5, 2.299), angle = Angle(-1.17, -10.52, -94.676), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_greaserblockhammer"] = { type = "Model", model = "models/newvegasprops/supersledge.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(5.9, -1, 10.899), angle = Angle(-8.183, -164.805, 3.506), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
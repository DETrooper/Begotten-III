...
SWEP.PrintName = "Nobleman's Sword"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "NoblemansSwordAttackTable"
SWEP.BlockTable = "NoblemansSwordBlockTable"
...
SWEP.VElements = {
	["v_inquisitorsword"] = { type = "Model", model = "models/demonssouls/weapons/penetrating_sword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, 5), angle = Angle(82.986, 0, 57.272), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_inquisitorsword"] = { type = "Model", model = "models/demonssouls/weapons/penetrating_sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1.5, 0), angle = Angle(-92.338, 90, 40), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
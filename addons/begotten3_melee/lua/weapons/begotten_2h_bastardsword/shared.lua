...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "BastardSwordAttackTable"
SWEP.BlockTable = "BastardSwordBlockTable"
...
SWEP.VElements = {
	["v_bastardsword"] = { type = "Model", model = "models/demonssouls/weapons/bastard_sword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0.5, 4), angle = Angle(82.986, 0, 57.272), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_bastardsword"] = { type = "Model", model = "models/demonssouls/weapons/bastard_sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1, -1), angle = Angle(-97.014, 73.636, -162.469), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
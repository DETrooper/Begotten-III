...
SWEP.PrintName = "Executioner's Axe"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "ExecutionersAxeAttackTable"
SWEP.BlockTable = "ExecutionersAxeBlockTable"
...
SWEP.VElements = {
	["v_executionersaxe"] = { type = "Model", model = "models/demonssouls/weapons/great_axe.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-3.201, 7, 1.48), angle = Angle(3, 87.777, 1.11), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {[0] = 3} }
}

SWEP.WElements = {
	["w_executionersaxe"] = { type = "Model", model = "models/demonssouls/weapons/great_axe.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.443, 0.493, 6.42), angle = Angle(78.888, 16.666, -101.112), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
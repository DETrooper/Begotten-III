...
local DATA = {}
DATA.Name = "begotten_javelin_shield"
DATA.HoldType = "wos-begotten_javelin_shield"
...
DATA.Translations[ ACT_COVER_LOW ] = {
	{ Sequence = "a_javelin_shield_crouch_idle", Weight = 1 },
}

DATA.Translations[ ACT_WALK_CROUCH ] = {
	{ Sequence = "a_javelin_shield_crouch_walk", Weight = 1 },
}

-- Idle
DATA.Translations[ ACT_IDLE_ANGRY_MELEE ] = {
	{ Sequence = "a_javelin_shield_unholstered_idle", Weight = 1 },
}
...
DATA.Translations[ ACT_WALK_AIM_RIFLE ] = {
	{ Sequence = "a_javelin_shield_unholstered_walk", Weight = 1 },
}
...
DATA.Translations[ ACT_RUN_AIM_RIFLE_STIMULATED ] = {
	{ Sequence = "a_javelin_shield_unholstered_run", Weight = 1 },
}

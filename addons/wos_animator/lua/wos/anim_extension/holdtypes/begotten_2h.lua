...
local DATA = {}
DATA.Name = "begotten_2h"
DATA.HoldType = "wos-begotten_2h"
...
DATA.Translations[ ACT_COVER_LOW ] = {
	{ Sequence = "a_heavy_2h_crouch_idle", Weight = 1 },
}

DATA.Translations[ ACT_WALK_CROUCH ] = {
	{ Sequence = "a_heavy_2h_crouch_walk", Weight = 1 },
}

-- Idle
DATA.Translations[ ACT_IDLE_ANGRY_MELEE ] = {
	{ Sequence = "a_heavy_2h_unholstered_idle", Weight = 1 },
}

DATA.Translations[ ACT_IDLE ] = {
	{ Sequence = "a_heavy_2h_holstered_idle", Weight = 1 },
}

-- Walking
DATA.Translations[ ACT_WALK ] = {
	{ Sequence = "a_heavy_2h_holstered_walk", Weight = 1 },
}

DATA.Translations[ ACT_WALK_AIM_RIFLE ] = {
	{ Sequence = "a_heavy_2h_unholstered_walk", Weight = 1 },
}

-- Running
DATA.Translations[ ACT_RUN ] = {
	{ Sequence = "a_heavy_2h_holstered_run", Weight = 1 },
}

DATA.Translations[ ACT_RUN_AIM_RIFLE_STIMULATED ] = {
	{ Sequence = "a_heavy_2h_unholstered_run", Weight = 1 },
}

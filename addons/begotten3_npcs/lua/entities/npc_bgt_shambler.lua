...
ENT.Models = {"models/begotten/thralls/shambler.mdl"}
...
ENT.ClimbProps = true
ENT.ClimbLedgesMaxHeight = 600
ENT.ClimbLadders = true
ENT.ClimbSpeed = 250
ENT.ClimbUpAnimation = ACT_ZOMBIE_CLIMB_UP--ACT_ZOMBIE_CLIMB_UP --pull_grenade
...
if SERVER then
 ...
 function ENT:OnRangeAttack()
	...
	self:SetCooldown("Leap", 6)
	self:SetVelocity(self:GetUp()*150)
